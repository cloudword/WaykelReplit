...
-   **Build Scripts**:
    -   `./scripts/build-mobile-customer.sh` - Build Customer app
    -   `./scripts/build-mobile-driver.sh` - Build Driver app
    -   `./scripts/init-mobile-platforms.sh` - Initialize both apps
